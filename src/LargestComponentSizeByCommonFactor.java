...
class LargestComponentSizeByCommonFactor {
    ...
    public static void main(String[] args) {
        final LargestComponentSizeByCommonFactor l = new LargestComponentSizeByCommonFactor();
//        assert(l.largestComponentSize(new int[]{4,6,15,35})==4);
//        assert(l.largestComponentSize(new int[]{20,50,9,63})==2);
        assert(l.largestComponentSize(new int[]{2,3,6,7,4,12,21,39})==8);
        assert(l.largestComponentSize(new int[]{99,100,69,39,14,56,91,60})==8);
    }
}